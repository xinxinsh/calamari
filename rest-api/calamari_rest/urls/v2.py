...
urlpatterns = patterns(
    ...
    url(r'^cluster/(?P<fsid>[a-zA-Z0-9-]+)/pool/(?P<pool_id>\d+)/rbd/(?P<rbd_name>[a-zA-Z0-9-_]+)/meta$',
        calamari_rest.views.v2.MetaViewSet.as_view({'get': 'list', 'post': 'create' }),
        name='cluster-rbd-meta'),
    ...
    url(r'^cluster/(?P<fsid>[a-zA-Z0-9-]+)/pool/(?P<pool_id>\d+)/rbd/(?P<rbd_name>[a-zA-Z0-9-_]+)/meta/(?P<key>[a-zA-Z0-9-_]+)$',
        calamari_rest.views.v2.MetaViewSet.as_view({'get': 'retrieve', 'delete': 'destroy', 'patch': 'update'}),
        name='cluster-rbd-meta-detail'),
